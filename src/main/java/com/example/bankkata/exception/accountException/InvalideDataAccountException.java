...
public class InvalideDataAccountException extends CustomException {

    private static final String CAUSE= "ERROR DATA";
    private static final long serialVersionUID = 2;
    private static final int code = HttpStatus.NOT_FOUND.value();

    public InvalideDataAccountException(String message){
        super(new CustomError(code,message,CAUSE));
    }
    public InvalideDataAccountException(){
